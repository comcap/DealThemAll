...
@section('content')
    <div id="box-item" class="container-fluid home-margin-top" style="margin-bottom: 80px">
        ...
        <div class="row d-none d-md-flex mt-2 align-items-center">
            <a href="#">
                ...
                <div class="d-flex justify-content-center">
                    <div class="row mx-0 mt-2">
                        <div class="col-12 p-2">
                            ...
                            <form action="/ApiSearch" method="POST">
                                @csrf
                                <div class="row p-2 py-4" style="height: auto; border-radius: 8px">
