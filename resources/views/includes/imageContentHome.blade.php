<div class="row mt-3 mx-0" style="height: 400px; background-color: rgba(0,0,0,1);">
            ...
            @foreach($item->imagePath as $key => $images)
                @if ($key == 0)
                    <div class="carousel-item active">
                        <img src="{{asset('data-image/post_asset/'.$images->asset_name)}}" class="content-image-center">
                    </div>
                    @continue
                @endif
